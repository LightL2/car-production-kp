...
PHOTO_EXTRA = 0              # Добавки отключены (смета по объёму)
VIDEO_EXTRA_TOTAL = 0
PHOTO_SCOPE_FACTOR = 0.96    # −4% фото (небольшое снижение)
VIDEO_POST_FACTOR = 0.4      # post: 1 ролик вместо 2–3 (÷2.5)
...
|------|----------|---------|---------------|-----------------|
| Фото | $55 449 | $6 654 | **$62 103** | 751 446 300 |
| TVC | $56 803 | $6 816 | **$63 619** | 769 789 900 |
| Overview | $44 567 | $5 348 | **$49 915** | 603 971 500 |
| Видео суммарно | $101 370 | $12 164 | **$113 534** | 1 373 761 400 |
| **Проект** | — | — | **$175 637** | **2 125 207 700** |
...
3. Project — контекст, 90 фото, 4 видео, сдача 01.09.2026
...
**Видео (4):** TVC 1, Exterior 1, Interior 1, Functions 1 · 4K UHD · 25/50fps · LOG · EN/RU/UZ subs
...
### Изменить объём / коэффициенты сметы
- `budget_adjust.py` → `PHOTO_SCOPE_FACTOR`, `VIDEO_*_FACTOR`, `VAT_RATE`
- Функция `apply_scope_revision()` применяется автоматически в `prepare_client_budget()`
